...
aboutText = """<p>""" + programName + """ : """ + programVersion + """
<br>Python: %(python)s
<br>wxPython: %(wxpy)s
<br>
<br>""" + programName + """ is released under the GNU GPL version 3.
<br>
<br>Homepage: <a href='http://eqso.titanix.net'>eqso.titanix.net</a></p>"""
...
class Frame(wx.Frame):
    ...
    def OnClose(self, event):
        dlg = wx.MessageDialog(self, 
            ...
            "Quit " + programName, wx.OK|wx.CANCEL|wx.ICON_QUESTION)
